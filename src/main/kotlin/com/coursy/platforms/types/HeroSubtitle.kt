...
@JvmInline
value class HeroSubtitle private constructor(val value: String) {
    companion object {
        private const val MIN_LENGTH = 1
        private const val MAX_LENGTH = 4000

        fun create(value: String): Either<ValidationFailure, HeroSubtitle> = when {
